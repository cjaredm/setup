...
function custom_image_sizes()
{
	...
	// Post
	add_image_size('post-small', 250, 250, true);
	add_image_size('slider-medium', 500, 500, true);
}
...
?>
	<img src="<?php echo esc_url(THEME_IMAGES); ?>/blank.png" class="<?php echo esc_attr($classes); ?>" alt="<?php echo esc_attr($image_alt); ?>" data-srcset="<?php echo esc_attr($image_sizes); ?>" data-sizes="auto">
<?php
}
